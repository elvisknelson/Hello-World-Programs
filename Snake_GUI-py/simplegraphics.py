...
def line(*pts):
  try:
    ...
    __canvas.create_line(new_pts, fill=__outline, width=__width, capstyle=__capstyle, joinstyle=__joinstyle)
    __update()
...
def curve(*pts):
  try:
    ...
    __canvas.create_line(new_pts, fill=__outline, width=__width, capstyle=__capstyle, smooth=True, splinesteps=25, joinstyle=__joinstyle)
    __update()
